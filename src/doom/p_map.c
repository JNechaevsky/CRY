...
//
// [BH] Allow pain elementals to shoot lost souls through 2-sided 
// walls with an ML_BLOCKMONSTERS flag. This is a compromise between 
// BOOM and Vanilla DOOM behaviors, and allows pain elementals
...
boolean PIT_CheckThing (mobj_t *thing)
{
    ...
    // [Julia] Torque: make sliding corpses passable
...
boolean P_ThingHeightClip (mobj_t *thing)
{
    ...
    if (onfloor)
    {
        ...
        // [Julia] Update player's view when on moving platform.
...
// PTR_ShootTraverse
//
// [Julia] Bullets no longer will dissapear in ledges. Thanks Fabian Greffrath!
// -----------------------------------------------------------------------------
...
boolean	PTR_UseTraverse (intercept_t * in)
{
    ...
    if (!in->d.line->special)
    {
        ...
        if (openrange <= 0)
        {
            // [Julia] Don't break oof sounds by shooting sounds.
...
boolean PIT_ChangeSector (mobj_t *thing)
{
    ...
    if (thing->health <= 0)
    {
        ...
        // [Julia] Initialize player's movement momentum for preventing
