...
state_t	states[NUMSTATES] = {
    ...
    {SPR_SHT2,32777,3,{A_Light2},S_LIGHTDONE},  // S_DSGUNFLASH2
    ...
    {SPR_MISL,32768,1000,{NULL},S_GRENADE},    // S_GRENADE
    {SPR_MISL,32769,4,{A_Scream},S_DETONATE2},  // S_DETONATE
    {SPR_MISL,32770,6,{NULL},S_DETONATE3},    // S_DETONATE2
...
#define BFGDELAY 1
#define OLDBFG_1FRAMES(x) {SPR_BFGG,1,BFGDELAY,{NULL},x+S_OLDBFG1+2},
...
#define OLDBFG_8FRAMES(x) OLDBFG_4FRAMES(x) OLDBFG_4FRAMES(x+4)
    ...
    {SPR_SKUL,5,5,{NULL},S_BSKUL_ATK3},    // S_BSKUL_ATK2
    ...
    {SPR_SKUL,16,5,{NULL},S_BSKUL_DIE8},  // S_BSKUL_DIE8
    {SPR_MISL,32769,8,{NULL},S_EXPLODE2}, // S_MUSHROOM
};
