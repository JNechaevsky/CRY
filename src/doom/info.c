...
state_t	states[NUMSTATES] = {
	...
	// [JN] Jaguar: emulate pistol animation
	...
	// [JN] Jaguar: emulate chaingun behavior (5 instead of 4)
	...
	// [JN] Jaguar: emulate chaingun behavior (4 instead of 5)
	...
	// [JN] Jaguar: emulate rocket launcher behavior (15 instead of 12)
	{SPR_MISG,1,15,{A_FireMissile},S_MISSILE3},	// S_MISSILE2
	{SPR_MISG,1,0,{A_ReFire},S_MISSILE},	// S_MISSILE3
	// [JN] Jaguar: emulate rocket launcher behavior (4 instead of 3)
	...
	// [JN] Jaguar: emulate chainsaw behavior (5 instead of 4)
	...
	// [JN] Jaguar: emulate plasma gun behavior (5 instead of 3)
	...
	// [JN] Jaguar: emulate BFG behavior (18 instead of 10)
	{SPR_BFGG,1,18,{A_FireBFG},S_BFG4},	// S_BFG3
	...
	{SPR_POSS,5|0x8000,8,{A_PosAttack},S_POSS_ATK3},	// S_POSS_ATK2
	...
	{SPR_CPOS,5|0x8000,1,{A_CPosRefire},S_CPOS_ATK2},	// S_CPOS_ATK4
	...
	{SPR_CYBR,5|0x8000,12,{A_CyberAttack},S_CYBER_ATK3},	// S_CYBER_ATK2
	{SPR_CYBR,4,12,{A_FaceTarget},S_CYBER_ATK4},	// S_CYBER_ATK3
	{SPR_CYBR,5|0x8000,12,{A_CyberAttack},S_CYBER_ATK5},	// S_CYBER_ATK4
	{SPR_CYBR,4,12,{A_FaceTarget},S_CYBER_ATK6},	// S_CYBER_ATK5
	{SPR_CYBR,5|0x8000,12,{A_CyberAttack},S_CYBER_RUN1},	// S_CYBER_ATK6
	...
	// [JN] Disable full bright for Suit, use brightmap instead.
	{SPR_SUIT,0,-1,{NULL},S_NULL},	// S_SUIT
	// [JN] Disable full bright for Automap, use brightmap instead.
	...
	{SPR_PVIS,0,6,{NULL},S_PVIS2},	// S_PVIS
	...
	{SPR_POL3,0,6,{NULL},S_HEADCANDLES2},	// S_HEADCANDLES
	{SPR_POL3,1,6,{NULL},S_HEADCANDLES},	// S_HEADCANDLES2
	...
	{SPR_CEYE,0,6,{NULL},S_EVILEYE2},	// S_EVILEYE
	{SPR_CEYE,1,6,{NULL},S_EVILEYE3},	// S_EVILEYE2
	{SPR_CEYE,2,6,{NULL},S_EVILEYE4},	// S_EVILEYE3
	{SPR_CEYE,1,6,{NULL},S_EVILEYE},	// S_EVILEYE4
	...
	{SPR_TBLU,0,4,{NULL},S_BLUETORCH2},	// S_BLUETORCH
	{SPR_TBLU,1,4,{NULL},S_BLUETORCH3},	// S_BLUETORCH2
	{SPR_TBLU,2,4,{NULL},S_BLUETORCH4},	// S_BLUETORCH3
	{SPR_TBLU,3,4,{NULL},S_BLUETORCH},	// S_BLUETORCH4
	// [JN] Disable full bright for Tall Green Torch, use brightmap instead.
	{SPR_TGRN,0,4,{NULL},S_GREENTORCH2},	// S_GREENTORCH
	{SPR_TGRN,1,4,{NULL},S_GREENTORCH3},	// S_GREENTORCH2
	{SPR_TGRN,2,4,{NULL},S_GREENTORCH4},	// S_GREENTORCH3
	{SPR_TGRN,3,4,{NULL},S_GREENTORCH},	// S_GREENTORCH4
	// [JN] Disable full bright for Tall Red Torch, use brightmap instead.
	{SPR_TRED,0,4,{NULL},S_REDTORCH2},	// S_REDTORCH
	{SPR_TRED,1,4,{NULL},S_REDTORCH3},	// S_REDTORCH2
	{SPR_TRED,2,4,{NULL},S_REDTORCH4},	// S_REDTORCH3
	{SPR_TRED,3,4,{NULL},S_REDTORCH},	// S_REDTORCH4
	...
	{SPR_TLMP,0,4,{NULL},S_TECHLAMP2},	// S_TECHLAMP
	{SPR_TLMP,1,4,{NULL},S_TECHLAMP3},	// S_TECHLAMP2
	{SPR_TLMP,2,4,{NULL},S_TECHLAMP4},	// S_TECHLAMP3
	{SPR_TLMP,3,4,{NULL},S_TECHLAMP},	// S_TECHLAMP4
	// [JN] Disable full bright for Short Tech Lamp, use brightmap instead.
	{SPR_TLP2,0,4,{NULL},S_TECH2LAMP2},	// S_TECH2LAMP
	{SPR_TLP2,1,4,{NULL},S_TECH2LAMP3},	// S_TECH2LAMP2
	{SPR_TLP2,2,4,{NULL},S_TECH2LAMP4},	// S_TECH2LAMP3
	{SPR_TLP2,3,4,{NULL},S_TECH2LAMP},	// S_TECH2LAMP4
};
...
mobjinfo_t mobjinfo[NUMMOBJTYPES] = {
	...
	60,		// spawnhealth // [JN] Jaguar: reduced health
	...
	2035,		// doomednum
	S_BAR1,		// spawnstate
	10,		// spawnhealth // [JN] Jaguar: reduced health
	S_NULL,		// seestate
	sfx_None,		// seesound
	8,		// reactiontime
	sfx_None,		// attacksound
	...
	983040,		// speed // [JN] Jaguar: reduced speed
	13*FRACUNIT,		// radius
	8*FRACUNIT,		// height
	100,		// mass
	100,		// damage
