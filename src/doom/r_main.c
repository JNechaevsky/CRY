...
void R_InitLightTables (void)
{
    ...
    for (i=0 ; i< LIGHTLEVELS ; i++)
    {
        ...
        // [Julia] Smoother diminished lighting
...
void R_ExecuteSetViewSize (void)
{
    ...
    else
    {
        ...
        // [Julia] reduced height (168 to 163), STBAR is 40 pixel tall.
        scaledviewheight = ((setblocks*163/10)&~7)<<hires;
    }
...
void R_Init (void)
{
    ...
    printf (".");
    // [Julia] Lookup all the textures for brightmapping
    if (brightmaps)
    {
        R_InitBrightmaps ();
        printf (".");
...
{		
    ...
    {
        // [Julia] Fix aftermath of "Invulnerability colormap bug" fix,
...
{	
    ...
    {
        // [Julia] fill whole screen with black color and don't go any farther
        V_DrawFilledBox(viewwindowx, viewwindowy, scaledviewwidth, scaledviewheight, 0);
        return;
    }    

    // [Julia] Draw map's "out of bounds" as a black color
    V_DrawFilledBox(viewwindowx, viewwindowy, scaledviewwidth, scaledviewheight, 0);
