...
int detailLevel; // [Julia] & [crispy] Необходимо для R_MapPlane
...
void R_DrawPlanes (void) 
{
    ...
    for (pl = visplanes ; pl < lastvisplane ; pl++)
    {
        ...
        if (pl->picnum == skyflatnum)
        {
            ...
            // [Julia] There is no invulnerability colormap,
            // so there is no necessity to fix this.
